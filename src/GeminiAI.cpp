...
const char* ssid = "EYUP DENEYAP";                                             //WIFI ssid
const char* password = "MTH#122016?!.";                                        //WIFI password
const char* Gemini_Token = "AIzaSyDxXRTIn2SFBXFurIDnVcXHvj4Cbjrn7po";          //Your Gemini AI API
